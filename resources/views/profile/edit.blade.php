...
@section('parentPageTitle', 'Edit Profile')
@section('page-style')
            ...
            <div class="card">
                <div class="body">
                    <form action="{{route('profile/update')}}" method="POST" enctype="multipart/form-data">
                        @csrf()
                        <h2 class="card-inside-title">Edit Profile</h2>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{($user->product_category)?$user->productCategory->name:'N/A'}}" readonly/>
                                    @if ($errors->has('name'))
                                        <span class="text-danger">{{ $errors->first('name') }}</span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <p>Profile Photo</p>
                                    <input type="file" name="profile_pic" class="dropify form-control" data-default-file="{{($user->profile_pic)?url($user->profile_pic):''}}" data-allowed-file-extensions="jpg jpeg png" data-max-file-size="2048K">
